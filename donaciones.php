...
<div id="fondo">
  ...
  <header id="header">
        <div class="container">
          <div class="row">
            <div class="col-md-10">
			  ...
			  Donaciones <small>Colectivo civico la Tortuga</small></h1>
            </div>
            <div class="col-md-2">
    ...
    <div class="proyecto">
			<li class=".letra_cata">Colectivo Civico CP la tortuga</li><br>

			<div class="letras"><ul>  N° 0200434549</ul>
			<ul><img src="img/vision12.png" width="913" height="536" /></ul><br>
			</div>
